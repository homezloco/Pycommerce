...
def migrate_tenant_categories(tenant_slug):
    ...
    """
    # This function must be called within a Flask app context
    # We'll wrap it with the app context to make it more robust
...
if __name__ == "__main__":
    # No need for app context here since migrate_categories() creates its own context
