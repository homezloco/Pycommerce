#!/usr/bin/env python3
"""Script to create a Portfolio page for Tech Gadgets.

This script creates a portfolio page for Tech Gadgets using the Portfolio Page template.
"""
...
def create_tech_portfolio_page():
    """Create a Portfolio page for Tech Gadgets."""
    session = SessionLocal()
    try:
        # Initialize managers
        ...
        # Get the tech tenant
        tenant = tenant_manager.get_by_slug("tech")
        if not tenant:
            logger.error("Tech Gadgets tenant not found")
            return
        ...
        if portfolio_page:
            logger.info(f"Portfolio page created successfully for Tech Gadgets")
        else:
            logger.error("Failed to create Portfolio page for Tech Gadgets")
...
if __name__ == "__main__":
    logger.info("Creating Portfolio page for Tech Gadgets...")
    create_tech_portfolio_page()
